...
$confirmLink = Url::to(['/user/email-confirm','id' => $id, 'auth_key' => $auth_key],true);
if ($back == 0) {
	$confirmLink = Yii::$app->urlFrontEnd->createUrl(['/user/email-confirm','id' => $id, 'auth_key' => $auth_key]);
}
...
<div class="password-reset">
	...
	<p>To receive email notification from HamsterEat, please verify your email address by clicking button below.</p>

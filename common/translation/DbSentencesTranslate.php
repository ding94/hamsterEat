 ...
 * @since 2.0
 */
class DbSentencesTranslate extends MessageSource
{
    /**
     ...
     */
    const CACHE_KEY_PREFIX = 'DbSentencesTranslate';
     ...
     */
    public $sourceMessageTable = '{{%sentences_source}}';
    /**
     * @var string the name of the translated message table.
     */
    public $messageTable = '{{%sentences}}';
    /**
